(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`data:image/svg+xml,%3csvg%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M24%2012.2727C24%2011.4218%2023.9221%2010.6036%2023.7774%209.81818H12.2449V14.4655H18.8349C18.5455%2015.96%2017.6772%2017.2255%2016.3748%2018.0764V21.0982H20.3488C22.6642%2019.0036%2024%2015.9273%2024%2012.2727Z'%20fill='%234285F4'/%3e%3cpath%20d='M12.2449%2024C15.551%2024%2018.3228%2022.9309%2020.3488%2021.0982L16.3748%2018.0764C15.2839%2018.7964%2013.8924%2019.2327%2012.2449%2019.2327C9.06122%2019.2327%206.35622%2017.1273%205.38776%2014.2909H1.31354V17.3891C3.32839%2021.3055%207.45826%2024%2012.2449%2024Z'%20fill='%2334A853'/%3e%3cpath%20d='M5.38776%2014.28C5.14286%2013.56%204.99814%2012.7964%204.99814%2012C4.99814%2011.2036%205.14286%2010.44%205.38776%209.72V6.62182H1.31354C0.478664%208.23636%200%2010.0582%200%2012C0%2013.9418%200.478664%2015.7636%201.31354%2017.3782L4.48609%2014.9564L5.38776%2014.28Z'%20fill='%23FBBC05'/%3e%3cpath%20d='M12.2449%204.77818C14.0482%204.77818%2015.6512%205.38909%2016.9314%206.56727L20.4379%203.13091C18.3117%201.18909%2015.551%200%2012.2449%200C7.45826%200%203.32839%202.69455%201.31354%206.62182L5.38776%209.72C6.35622%206.88364%209.06122%204.77818%2012.2449%204.77818Z'%20fill='%23EA4335'/%3e%3c/svg%3e`;function t(){let t=document.createElement(`div`);t.className=`auth-overlay`,t.innerHTML=`
  ...
  `;let n=e.querySelector(`.header__menu`),r=e.querySelector(`.header__mobile-close`),i=e.querySelector(`.header__mobile-menu`),a=e.querySelector(`.header__backdrop`);e.querySelector(`.header__login`)?.addEventListener(`click`,()=>{document.querySelector(`.auth-overlay`)||document.body.append(t())});function o(){i?.classList.add(`header__mobile-menu--open`),a?.classList.add(`header__backdrop--visible`),n?.setAttribute(`aria-expanded`,`true`),i?.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`menu-open`)}function s(){i?.classList.remove(`header__mobile-menu--open`),a?.classList.remove(`header__backdrop--visible`),n?.setAttribute(`aria-expanded`,`false`),i?.setAttribute(`aria-hidden`,`true`),document.body.classList.remove(`menu-open`)}n?.addEventListener(`click`,o),r?.addEventListener(`click`,s),a?.addEventListener(`click`,s);let c=e.querySelectorAll(`.header__mobile-link`);for(let e of c)e.addEventListener(`click`,s);return e}function r(){let e=document.createElement(`section`);return e.className=`hero`,e.innerHTML=`
  ...
  `,e}function i({title:e,imageSrc:t,rating:n,likes:r,className:i=``}){let a=document.createElement(`article`);a.className=`game-card ${i}`.trim();let o=n&&r?`
  ...
  `}
  `,a}var a=[{title:`Tailside: Cozy Cafe Sim`,imageSrc:`/src/assets/tailside-cozy-cafe-sim-card.jpg`,rating:`4.8`,likes:`35.6K`,className:`game-card--edge`},{title:`ISLANDERS: New Shores`,imageSrc:`/src/assets/islanders-new-shores-card.jpg`,rating:`4.9`,likes:`54.2K`,className:`game-card--regular`},{title:`Vacation Cafe Simulator`,imageSrc:`/src/assets/vacation-cafe-simulator-card.jpg`,rating:`4.8`,likes:`28.7K`,className:`game-card--featured`},{title:`Winter Burrow`,imageSrc:`/src/assets/winter-burrow-card.jpg`,rating:`4.9`,likes:`32.4K`,className:`game-card--regular`},{title:`Shelve the Potions!`,imageSrc:`/src/assets/shelve-the-potions-card.jpg`,rating:`4.7`,likes:`21.3K`,className:`game-card--edge`}];function o(){let e=document.createElement(`section`);e.className=`new-games`,e.innerHTML=`
      ...
      <table class="leaderboard__table">
        ...
        <tr>
          ...
          <td class="leaderboard__player">
            <span class="leaderboard__avatar">${c(e.playerName)}</span>
  ...
  `,e}var u=`/minigames/assets/illustration-side-DsQZrXDY.png`,d=`data:image/svg+xml,%3csvg%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M12%203V15M7%208L12%203L17%208M21%2015V19C21%2019.5304%2020.7893%2020.0391%2020.4142%2020.4142C20.0391%2020.7893%2019.5304%2021%2019%2021H5C4.46957%2021%203.96086%2020.7893%203.58579%2020.4142C3.21071%2020.0391%203%2019.5304%203%2019V15'%20stroke='%23242145'%20stroke-width='2'%20stroke-linecap='round'/%3e%3c/svg%3e`;function f(){let e=document.createElement(`section`);return e.className=`developer-cta`,e.innerHTML=`
    <img
  ...
  `,e}function _(){let e=document.createElement(`div`);e.append(n());let t=document.createElement(`main`);return t.append(r()),t.append(o()),t.append(l()),t.append(f()),t.append(g()),e.append(t),e}var v=document.createElement(`div`);v.id=`app`,document.body.append(v),v.append(_());